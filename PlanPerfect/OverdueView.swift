...
//  PlanPerfect
//
//  Created by Danesh Zhao-Graham on 2023-03-26.
//
...
struct OverdueView: View {
    ...
    var body: some View {
        ...
        VStack {
            List {
                ForEach(items) { item in
                    if item.isOverdue(){
                        TaskViewCell(passedTaskItem: item, color: Color(red: 1, green: 0.27, blue: 0.23))
        ...
        .onAppear(perform: {
            UINavigationBar.appearance().largeTitleTextAttributes = [.foregroundColor: UIColor(red: 1, green: 0.27, blue: 0.23, alpha: 1)]
            UINavigationBar.appearance().titleTextAttributes = [.foregroundColor: UIColor(red: 1, green: 0.27, blue: 0.23, alpha: 1)]
